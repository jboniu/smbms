...
<!--时间-->
    <section class="publicTime">
        <span id="time">2024年6月17日 11:11  星期一</span>
<%--        <a href="#">温馨提示：为了能正常浏览，请使用高版本浏览器！（IE10+）</a>--%>
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${pageContext.request.contextPath }/bill?method=query">订单管理</a></li>
              <li><a href="${pageContext.request.contextPath }/provider?method=query">供应商管理</a></li>
